...
(async function fetchData(dataArray = []) {
  ...
  const urlArray = [
    'https://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=6d23eda93f2346764a430a8b3530e7fd',
    'https://api.openweathermap.org/data/2.5/weather?q=Houston&APPID=6d23eda93f2346764a430a8b3530e7fd',
    'https://api.openweathermap.org/data/2.5/weather?q=Lisbon&APPID=6d23eda93f2346764a430a8b3530e7fd',
    'https://api.openweathermap.org/data/2.5/weather?q=Baltimore&APPID=6d23eda93f2346764a430a8b3530e7fd',
  ];
    ...
    makeRequest(url).then(function (result) {
      ...
      if (dataArray.length == urlArray.length) {
        ...
        for (let i = 0; i < dataArray.length; i++) {
          let itemInDataArray = dataArray[i];
